...
```
cd nola
mkvirtualenv --no-site-packages nola
...
```
* * * * * ubuntu bash /home/ubuntu/apps/nola/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|nola|tweet|`location`||||
|nola|facebook|`location`||||
|nola|email|`location`||||
|nola|new-comment||||
|nola|open-share-discuss||||
|nola|close-share-discuss||||
|nola|summary-copied||||
